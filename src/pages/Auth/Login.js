...
const Login = () => {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            ...
            // DEMO FALLBACK: ONLY if API fails/not running
            const { email, password } = credentials;
            let demoRole = '';

            if (password === '123456') {
                if (email === 'admin@medad.com') demoRole = 'admin';
                else if (email === 'rest@medad.com') demoRole = 'restaurant';
                else if (email === 'charity@medad.com') demoRole = 'charity';
            }
            ...
            if (demoRole) {
                ...
                else if (demoRole === 'restaurant') navigate('/restaurant/dashboard');
                else navigate('/browse');
            } else {
